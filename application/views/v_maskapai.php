  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box">
          <div class="box-body">
            <a class="btn btn-primary" href="<?php echo base_url('admin/maskapai'); ?>" style="margin-bottom: 10px;"><i class="fa fa-plus"> Tambah</i></a>
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $s->seat ?></td>
                  <td><?php echo $s->id_type ?></td>
                  <td>
                    <a class="btn btn-danger" style="color:white; cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_maskapai/'.$s->id)); ?>'"><i class="glyphicon glyphicon-trash"></i></a>
                    <a class="btn btn-primary" style="color:white; cursor: pointer; " title="" onclick="href='<?php echo base_url(('admin/edit_maskapai/'.$s->id)); ?>'"><i class="glyphicon glyphicon-pencil"></i></a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
