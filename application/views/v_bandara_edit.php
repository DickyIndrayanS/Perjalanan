        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            ...
            <form action="<?php echo base_url('admin/update_bandara'); ?>" method="post">
              ...
              <input type="hidden" class="form-control" name="id" required="true" hidden="true" value="<?php echo $s->id ?>">
              <div class="form-group">
                <label>Kode :</label>
                <input type="text" class="form-control" name="kode" required="true" value="<?php echo $s->kode ?>">
              </div>

              <div class="form-group">
                <label>Nama Bandara :</label>
                <input type="text" class="form-control" name="nama" required="true" value="<?php echo $s->nama ?> ">
              </div>

              <div class="form-group">
                <label>Kota :</label>
                <input type="text" class="form-control" name="kota" required="true" value="<?php echo $s->kota ?>">
              </div>
