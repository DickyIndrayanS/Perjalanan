      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><b>Status Perjalanan</b></h3>
            <div class="box-body no-padding">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn btn-danger"><a style="color:white; cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_rute/'.$s->id)); ?>'">Delete</a>
                    </div>
                    <div class="btn btn-primary"><a style="color:white; cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/edit_rute/'.$s->id)); ?>'">Edit</a>
                    </div>
                  </td>
                </tr>
