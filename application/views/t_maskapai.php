    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
            <form action="<?php echo base_url('admin/tambah_maskapai'); ?>" method="post">
              <!-- Date dd/mm/yyyy -->
              
                
              <input type="hidden" class="form-control" name="id" required="true" hidden="true">
              ...
              <div class="form-group">
                <label>Seat :</label>
                <input type="text" class="form-control" name="seat" required="true">
              </div>
              <!-- /.form group -->

              <div class="form-group">
                <label>Id Type :</label>
                <input type="text" class="form-control" name="id_type" required="true">
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
