  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="../../index2.html" class="logo">
        ...
        <span class="logo-mini">Board</span>
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="hidden-xs">Dicky Indrayan S</span>
      </a>
      <ul class="dropdown-menu">
        <!-- User image -->
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo base_url('admin/data_maskapai'); ?>"><i class="glyphicon glyphicon-compressed"></i>Bandara</a></li>
        </ul>
      </li>
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box">
          <div class="box-body">
            <a class="btn btn-primary" href="<?php echo base_url('admin/bandara'); ?>" style="margin-bottom: 10px;"><i class="fa fa-plus"> Tambah</i></a>
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-danger" style="color:white; cursor: pointer;" title="" onclick="href='<?php echo base_url(('admin/hapus_bandara/'.$s->id)); ?>'"><i class="glyphicon glyphicon-trash"></i></a>
                    <a class="btn btn-primary" style="color:white; cursor: pointer; " title="" onclick="href='<?php echo base_url(('admin/edit_bandara/'.$s->id)); ?>'"><i class="glyphicon glyphicon-pencil"></i></a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2018 Dicky Indrayan S </strong> All rights
  reserved.
</footer>
