      ...
      <div class="col-md-6">
        ...
        <div class="box box-danger">
          <div class="box-header">
            <h3 class="box-title"><b>Input</b></h3>
          </div>
          <div class="box-body">
            <?php foreach($maskapai as $s){ ?>
            <form action="<?php echo base_url('admin/update_maskapai'); ?>" method="post">
              <!-- Date dd/mm/yyyy -->
              
                
              <input type="hidden" name="id" hidden="true" value="<?php echo $s->id ?>">
              ...
              <div class="form-group">
                <label>Code :</label>
                <input type="text" class="form-control" name="code" value="<?php echo $s->code ?>">
              </div>

              <div class="form-group">
                <label>Deskripsi :</label>
                <input type="text" class="form-control" name="deskripsi" value="<?php echo $s->deskripsi ?>">
              </div>

              <div class="form-group">
                <label>Seat :</label>
                <input type="text" class="form-control" name="seat" value="<?php echo $s->seat ?>">
              </div>
              <!-- /.form group -->

              <div class="form-group">
                <label>Id Type :</label>
                <input type="text" class="form-control" name="id_type" value="<?php echo $s->id_type ?>">
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
